...
namespace Wip.Bones.Host.Tests.Compliance;

public sealed record WipBonesHostBehaviorProofReport(
...
public static class WipBonesHostBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.Host.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenWipBonesHostChecklistItems_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesHostBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesHostBehaviorProofReport(
