...
namespace Wip.Bones.ModelProviders.DeepSeek.Tests.Compliance;

public sealed record WipBonesDeepSeekBehaviorProofReport(
...
public static class WipBonesDeepSeekBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.DeepSeek.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenWipBonesDeepSeekChecklistItems_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesDeepSeekBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesDeepSeekBehaviorProofReport(
