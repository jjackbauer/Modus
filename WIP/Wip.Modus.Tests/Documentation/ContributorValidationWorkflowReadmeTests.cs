...
public sealed class ContributorValidationWorkflowReadmeTests
{
    ...
    public void ContributorWorkflowReadme_GivenDocumentedValidationCommands_CommandsExecuteInRepositoryAndProduceExpectedSuccessSignals()
    {
        ...
        Assert.Contains("dotnet build WIP/Wip.Modus/Wip.Modus.csproj -v minimal", readme, StringComparison.Ordinal);
        Assert.Contains("dotnet test WIP/Wip.Modus.Tests/Wip.Modus.Tests.csproj -v minimal", readme, StringComparison.Ordinal);
