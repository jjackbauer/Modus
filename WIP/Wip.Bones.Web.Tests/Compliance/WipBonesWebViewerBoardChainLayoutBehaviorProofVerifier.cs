...
public sealed record WipBonesWebViewerBoardChainLayoutBehaviorProofReport(
...
public static class WipBonesWebViewerBoardChainLayoutBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.ViewerBoardChainLayout.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenViewerBoardChainLayoutRequirements_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesWebViewerBoardChainLayoutBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesWebViewerBoardChainLayoutBehaviorProofReport(
