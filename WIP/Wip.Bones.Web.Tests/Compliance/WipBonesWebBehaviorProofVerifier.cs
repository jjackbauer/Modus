...
public sealed record WipBonesWebBehaviorProofReport(
...
public static class WipBonesWebBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.ViewerVisualization.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenViewerVisualizationRequirements_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesWebBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesWebBehaviorProofReport(
