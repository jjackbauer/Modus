...
public sealed record WipBonesWebViewerDominoRenderingBehaviorProofReport(
...
public static class WipBonesWebViewerDominoRenderingBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.ViewerDominoRendering.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenViewerDominoRenderingRequirements_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesWebViewerDominoRenderingBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesWebViewerDominoRenderingBehaviorProofReport(
