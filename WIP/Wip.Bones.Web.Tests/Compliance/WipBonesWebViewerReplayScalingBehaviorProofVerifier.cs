...
public sealed record WipBonesWebViewerReplayScalingBehaviorProofReport(
...
public static class WipBonesWebViewerReplayScalingBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.ViewerReplayScaling.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenViewerReplayScalingRequirements_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesWebViewerReplayScalingBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesWebViewerReplayScalingBehaviorProofReport(
