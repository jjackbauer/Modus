...
public sealed record WipBonesWebViewerLearningLoopStatusBehaviorProofReport(
...
public static class WipBonesWebViewerLearningLoopStatusBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.ViewerLearningLoopStatus.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenViewerLearningLoopStatusRequirements_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesWebViewerLearningLoopStatusBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        var plannedIntegrationTests = BehaviorProofPolicy.ParsePlannedIntegrationTests(requirementsMarkdown)
            .Where(test => !test.Section.Contains("Wip.Bones.Host", StringComparison.Ordinal))
            .ToArray();
        ...
        return new WipBonesWebViewerLearningLoopStatusBehaviorProofReport(
