...
namespace Wip.Bones.Web.Tests.Compliance;

public sealed record WipBonesWebViewerLayoutAndStabilityBehaviorProofReport(
...
public static class WipBonesWebViewerLayoutAndStabilityBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.ViewerLayoutAndStability.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenViewerLayoutAndStabilityRequirements_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesWebViewerLayoutAndStabilityBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        var plannedIntegrationTests = BehaviorProofPolicy.ParsePlannedIntegrationTests(requirementsMarkdown)
            .Where(test => !test.Section.Contains("BonesHostFeedTests", StringComparison.Ordinal))
            .ToArray();
        ...
        return new WipBonesWebViewerLayoutAndStabilityBehaviorProofReport(
