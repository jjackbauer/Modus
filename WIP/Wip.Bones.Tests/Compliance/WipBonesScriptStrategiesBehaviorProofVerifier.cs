...
public sealed record WipBonesScriptStrategiesBehaviorProofReport(
...
public static class WipBonesScriptStrategiesBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.ScriptStrategies.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofCompliance_GivenScriptStrategiesRequirements_RequiresExecutableRuntimeProofForEachItem";
    ...
    public static WipBonesScriptStrategiesBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesScriptStrategiesBehaviorProofReport(
