...
public sealed record WipBonesBoardOrientationBehaviorProofReport(
...
public static class WipBonesBoardOrientationBehaviorProofVerifier
{
    public const string RequirementsRelativePath = "harness/requirements/Wip.Bones.BoardOrientation.md";

    public const string CanonicalComplianceTestName =
        "BehaviorProofComplianceGate_GivenBoardOrientationChecklist_ExpectedAllTraitsBound";
    ...
    public static WipBonesBoardOrientationBehaviorProofReport Evaluate(
        ...
        IReadOnlyCollection<DiscoveredComplianceTestMethod> discoveredTests)
    {
        ...
        return new WipBonesBoardOrientationBehaviorProofReport(
