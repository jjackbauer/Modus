...
public sealed class BonesAsyncScriptStrategyPlayerSlot : IAsyncBonesPlayerSlot
{
    ...
    public BonesAsyncScriptStrategyPlayerSlot(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var selectedMove = await Task.Run(
            () => _host.ExecuteChooseMove(compiled, state, legalMoves),
