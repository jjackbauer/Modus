...
RequirementsDoc:<Optional path; defaults to harness/requirements/<CsProject>.md>
```
...
- Pull the named test list from prior requirements output, or re-run test-standards.
- Keep only tests that satisfy hard rules.
- Run falsify-claims on test assumptions and iterate until zero Falsified rows.
...
- Capture implementation claims and run falsify-claims.
