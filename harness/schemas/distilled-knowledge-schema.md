---
kind: schema
description: Canonical header, uncertainty markers, and update criteria for distilled knowledge documents.
---

# Distilled Knowledge Schema

> Usage: include this file in prompts that read or write distilled docs under harness/archive/distilled/.
