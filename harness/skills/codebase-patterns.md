...
harness/schemas/codebase-patterns.md. Run this skill when code conventions evolve,
new modules/plugins are added, or the reference drifts from implementation reality.

## Depends On

- harness/schemas/codebase-patterns.md
...
Update harness/schemas/codebase-patterns.md with a clear sectioned structure for:
...
Updated harness/schemas/codebase-patterns.md with a short trailing note:
