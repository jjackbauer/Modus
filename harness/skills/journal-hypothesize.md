...
You do not validate hypotheses here — that is the job of journal-validate.
You do not promote hypotheses to established facts — that is the job of journal-distill.

## Procedure

### Step 1 — Read the input OBS entries

Read `harness/archive/journals/observations.md` and extract the specified OBS entries in full.
Also read `harness/archive/journals/hypotheses.md` to check for duplicate or superseded claims.
...
- Must describe **what counter-evidence would look like**.
- Must be actionable by a future journal-validate invocation.
...
3. Append each HYP entry to `harness/archive/journals/hypotheses.md`.
