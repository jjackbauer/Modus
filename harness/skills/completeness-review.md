...
DistilledDir: <Path to distilled docs; defaults to harness/archive/distilled/>
```
...
If Scope includes source-target comparison, invoke impl-completeness for selected pairs.
