...
composes:
  ...
  - iterative-implementation-orchestrator.md
  - falsify-claims.md
  - plan-format-gate.md
---
...
1. Formal plugin requirements spec (requirements doc) generated via `requirements-gathering`.
...
RequirementsDoc:     <Optional; default: harness/requirements/<PluginName>.md>
...
1. The spec must be generated using `requirements-gathering`.
...
Run `iterative-implementation-orchestrator` with:
