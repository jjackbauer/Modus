...
kind: rule
mode: agent
description: Enforce typed semantic identifiers instead of raw strings in plugin framework contracts and DTOs.
assertMdc: no-primitive-obsession
---
...
```csharp
// PROHIBITED â€” use PluginId instead
string PluginId { get; }
string pluginId

// PROHIBITED â€” use OperationName instead
string Operation { get; }
IReadOnlyCollection<string> SupportedOperations { get; }
string operation

// PROHIBITED â€” use ContractName instead
string ContractName { get; }

// PROHIBITED â€” use JobName instead
string jobName

// PROHIBITED â€” use CapabilityName instead
IReadOnlyList<string> Capabilities { get; }
IReadOnlyList<string> DependsOn { get; }
IReadOnlyList<string> MissingCapabilities { get; }

// PROHIBITED â€” use CorrelationId? instead
string? CorrelationId { get; }

// PROHIBITED â€” use SyncResponseStatus? instead
string? Status { get; }

// PROHIBITED â€” use typed generic instead
