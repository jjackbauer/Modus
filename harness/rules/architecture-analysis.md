...
composes:
  - ../workflows/codebase-exploration.md
---
...
Pre-configured specialization of codebase-exploration for architecture and design documentation
...
Follow codebase-exploration with the parameter bindings below.
...
When applying journal-observe, prioritize observations that inform:
...
When applying journal-validate, prioritize boundary claims:
...
Run this rule repeatedly until convergence-metrics reports:
